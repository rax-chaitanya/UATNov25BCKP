({
    doInit : function(component, event, helper) {
        ...
        var dealType = component.find("typeOfDealPicklist").get("v.value");
        console.log('Deal type in do init::',dealType);
        component.set("v.typeOfDealSelected", "Referral");
    ...
    handleOnSubmit : function(component, event, helper) {
        ...
        var dealType = component.get("v.typeOfDealSelected");
        console.log("Type of deal assignment::",dealType);
        component.set("v.TypeOfDeal", dealType);
    ...
    handleDealChange : function(component,event,helper){
        var dealType = component.find("typeOfDealPicklist").get("v.value");
        console.log('Deal type on handle change::',dealType);
        component.set("v.typeOfDealSelected", dealType);
    }
